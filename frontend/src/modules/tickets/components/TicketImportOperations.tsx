// src/modules/tickets/components/TicketImportOperations.tsx
...
export function TicketImportHistoryModal() {
    const [show, setShow] = useState(false);
    const { data, isLoading, error } = useGetTicketImportHistoryQuery(undefined, {
        skip: !show,
    });
        ...
        <>
            ...
            <Modal show={show} onHide={() => setShow(false)} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title>Ticket Import History</Modal.Title>
                </Modal.Header>
                <Modal.Body>
