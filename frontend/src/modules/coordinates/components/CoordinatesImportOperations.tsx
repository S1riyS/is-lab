// src/modules/coordinates/components/CoordinatesImportOperations.tsx
...
export function ImportCoordinatesButton() {
...
export function CoordinatesImportHistoryModal() {
    const [show, setShow] = useState(false);
    const { data, isLoading, error } = useGetCoordinatesImportHistoryQuery(undefined, {
        skip: !show,
    });
        ...
        <>
            ...
            <Modal show={show} onHide={() => setShow(false)} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title>Coordinates Import History</Modal.Title>
                </Modal.Header>
                <Modal.Body>
